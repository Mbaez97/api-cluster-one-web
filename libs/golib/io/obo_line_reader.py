from libs.golib.config.obo_line_reader_contracts import OboLineReaderContracts
from libs.golib.io.abstract_line_reader import AbstractLineReader
...
class OboLineReader(AbstractLineReader):
    ...
    def _line_is_useful(self, line: str) -> bool:
        return (
            line
            and line.strip()
            and not line.startswith(OboLineReaderContracts.comment_char)
        )
