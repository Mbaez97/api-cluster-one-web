...
from libs.golib.io.obo_format_error import OboFormatError

from libs.golib.io.obo_line_reader import OboLineReader
from libs.golib.io.parse_error import ParseError
from libs.golib.io.stanza import Stanza
from libs.golib.io.value import Value
    ...
    def _parse_line(self, line: str) -> Tuple[str, Value]:
        ...
        if not match:
            raise OboFormatError(
                f"Cannot parse. Line '{line}' has " "unexpected format."
            )
