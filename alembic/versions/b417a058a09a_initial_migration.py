...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_protein_complex_id'), 'protein_complex', ['id'], unique=False)
    op.create_table('cluster_graph',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['id'], ['graph.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['protein_a_id'], ['protein.id'], ),
    sa.ForeignKeyConstraint(['protein_b_id'], ['protein.id'], ),
    sa.ForeignKeyConstraint(['style_id'], ['style.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_edge_id'), 'edge', ['id'], unique=False)
    op.create_table('ppi_graph',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
    ...
    op.create_table('complex_cluster_one_interaction',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['cluster_id'], ['cluster_graph.id'], ),
    sa.ForeignKeyConstraint(['complex_id'], ['protein_complex.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_complex_cluster_one_interaction_id'), 'complex_cluster_one_interaction', ['id'], unique=False)
    op.create_table('edge_cluster_interaction',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['ppi_interaction_id'], ['ppi_graph.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_edge_cluster_interaction_id'), 'edge_cluster_interaction', ['id'], unique=False)
    op.create_table('edge_ppi_interaction',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('edge_id', sa.Integer(), nullable=True),
    sa.Column('ppi_interaction_id', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    ...
    op.create_index(op.f('ix_edge_ppi_interaction_id'), 'edge_ppi_interaction', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_edge_cluster_interaction_id'), table_name='edge_cluster_interaction')
    op.drop_table('edge_cluster_interaction')
    op.drop_index(op.f('ix_complex_cluster_one_interaction_id'), table_name='complex_cluster_one_interaction')
